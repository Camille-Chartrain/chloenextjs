    ...
    <>
      ...
      <section className="durabilite">
        ...
        <p className="text">
          ...
          intemporelle. Cependant, il est essentiel de comprendre que le béton
          ciré et les enduits décoratifs sont des revêtements minces qui suivent
        ...
        <p className="text">
          ...
          bâtiment et des supports.
        </p>
        <p className="text">
          La prévention passe par une préparation rigoureuse du support et
          l’utilisation de produits de qualité. Néanmoins, envisager la
          possibilité de fissuration fait partie d’une approche réaliste et
          responsable. Un béton ciré bien posé et bien entretenu reste un
